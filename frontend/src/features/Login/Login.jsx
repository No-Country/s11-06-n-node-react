                ...
                <div className="flex items-center gap-3 flex-col text-center w-[100%] sm:w-[70%] ">
                  <div className="flex flex-col justify-center gap-3 sm:flex sm:items-center sm:w-[60%] ">
                    ...
                    <div className="flex flex-col justify-center w-[100%] sm:w-[100%] ">
                      <input
                        className="p-[10px] focus:outline-none border-2 min-w-[200px] border-[#E5E7EB]  w-[100%] rounded-md h-12 focus-visible:ring-greenSecundary focus:border-greenSecundary"
                        type="email"
                      ...
                      {errors.email && (
                        <span className="mb-[3%] sm:w-[100%] flex text-red-800 text-sm">
                    ...
                    <div className="flex flex-col justify-center w-[100%] sm:w-[100%] ">
                      <input
                        type="password"
                        className="p-[10px] focus:outline-none focus-visible:ring-greenSecundary focus:border-greenSecundary border-2  min-w-[200px] sm:w-[100%]  border-[#E5E7EB] rounded-md h-12"
                      ...
                      />
                      {errors.password && (
                        <span className="sm:w-[100%] flex text-red-800 text-sm  sm:text-sm">
                          {errors.password.message}
                        </span>
                      )}
                    </div>
                    <button className="min-w-[200px] flex justify-start w-[50%]">
                    ...
                    <button
                      ...
                      className={
                        errors.password
                          ? "bg-[#97CAC5] sm:w-[80%] active:false min-w-[200px] rounded-md px-5 py-2.5 text-white "
                          : "min-w-[200px] bg-[#11aa9e] sm:w-[80%] text-sm sm:text-base rounded-md px-5 py-2.5 text-white hover:bg-[#098D82]"
                      }
                    >
                      Continuar
                    </button>
                    ...
                    <Link
                      to="/register"
                      className="min-w-[200px] text-white sm:w-[80%] bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm sm:text-base px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                    >
                      Crear Cuenta
                    </Link>
                  </div>
