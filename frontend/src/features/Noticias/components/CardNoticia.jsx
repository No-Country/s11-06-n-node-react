    ...
    <div className="border border-gray-200 flex p-5 rounded-lg shadow-lg">
      ...
      <div className="w-2/3 pl-4 flex flex-col gap-y-5">
        <div className="flex items-center gap-x-3">
          ...
          <div className="w-full relative">
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center">
              <p>12/10/23</p>
              <p className="border border-gray-500 px-2 py-1 rounded-2xl flex items-center w-fit mt-2 md:mt-0 text-sm">
        ...
        <div className="flex flex-col gap-y-5">
          <p>hola que tal</p>
          <p className="text-gray-500 text-sm flex justify-end items-center gap-x-1">
            123 mates comentaron{' '}
